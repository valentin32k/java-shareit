...
class ItemServiceImplTest {
    ...
    void getUserItemsWithWrongFrom_shouldThrowBadMethodArgumentsException() {
        BadMethodArgumentsException exception = assertThrows(
                BadMethodArgumentsException.class, () -> service.getUserItems(1L, -1, 20));
        assertEquals("Items size must not be less than 1 " +
    ...
    void getUserItemsWithWrongSize_shouldThrowBadMethodArgumentsException() {
        BadMethodArgumentsException exception = assertThrows(
                BadMethodArgumentsException.class, () -> service.getUserItems(1L, 0, 0));
        assertEquals("Items size must not be less than 1 " +
                "and start item number must not be less then 0", exception.getMessage());
    }
    ...
    void findItemsWithTextWithWrongFrom_shouldThrowBadMethodArgumentsException() {
        BadMethodArgumentsException exception = assertThrows(
                BadMethodArgumentsException.class, () -> service.findItemsWithText("text", -1, 20));
        assertEquals("Items size must not be less than 1 " +
                "and start item number must not be less then 0", exception.getMessage());
    }
    ...
    void findItemsWithTextWithWrongSize_shouldThrowBadMethodArgumentsException() {
        BadMethodArgumentsException exception = assertThrows(
                BadMethodArgumentsException.class, () -> service.findItemsWithText("text", 1, 0));
        assertEquals("Items size must not be less than 1 " +
                "and start item number must not be less then 0", exception.getMessage());
    }
