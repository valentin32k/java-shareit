...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    BookingShort findFirstByItemIdAndStartIsBeforeAndStatusOrderByStartDesc(long itemId, LocalDateTime currentTime, BookingStatus state);
    ...
    List<Booking> findAllByBookerIdAndItemIdAndStatusAndEndIsBefore(long bookerId, long itemId, BookingStatus status, LocalDateTime currentTime);
}