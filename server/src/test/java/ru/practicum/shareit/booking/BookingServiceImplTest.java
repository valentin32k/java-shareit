...
class BookingServiceImplTest {
    ...
    void getBookingsByUserId_shouldThrowBadMethodArgumentsException() {
        ...
        ArithmeticException exception = assertThrows(
                ArithmeticException.class, () -> service.getBookingsByUserId(BookingState.ALL, 1, 0, 1));
    }
    ...
    void getOwnerItemsBookings_shouldThrowBadMethodArgumentsException() {
        ...
        ArithmeticException exception = assertThrows(
                ArithmeticException.class, () -> service.getOwnerItemsBookings(BookingState.ALL, 1, 0, 1));
    }
